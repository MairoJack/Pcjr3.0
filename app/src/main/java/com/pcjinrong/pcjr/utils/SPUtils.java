...
public class SPUtils
{
    ...
    public static Token getToken(Context context){
        ...
        token.setAccess_token(sp.getString("access_token",""));
        token.setRefresh_token(sp.getString("refresh_token",""));
        token.setExpires_in(sp.getString("expires_in",""));
        token.setToken_type(sp.getString("token_type",""));

        return token;

    }

    public static void putToken(Context context, Token token){
        SharedPreferences sp = context.getSharedPreferences(FILE_NAME,
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
