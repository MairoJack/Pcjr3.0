...
import com.pcjinrong.pcjr.utils.AlertAnimateUtils;
...
public class AlertView {
    ...
    public Animation getInAnimation() {
        int res = AlertAnimateUtils.getAnimationResource(this.gravity, true);
        return AnimationUtils.loadAnimation(context, res);
    }

    public Animation getOutAnimation() {
        int res = AlertAnimateUtils.getAnimationResource(this.gravity, false);
        return AnimationUtils.loadAnimation(context, res);
    }
